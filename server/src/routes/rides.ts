...
rideRouter.post('/rider-request', validate(rideValidation.requestRideByRider), rideController.requestRideByRider)rideRouter.get('/find-ride-by-rider',  rideController.findRideByRider);
